    ...
    <div class="row">
      <div class="col-sm-12 col-sm-4 col-md-4 text-center">
        <div class="media media--adapt">
          <img class="multicolumn-card__image" srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/icon-1-selling_3b293051-4589-426e-b6a9-a685cd3bd606.png" src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon-1-selling_3b293051-4589-426e-b6a9-a685cd3bd606.png&amp;width=550" sizes="(min-width: 990px) 550px, (min-width: 750px) 550px, calc(100vw - 30px)" alt="" height="123" width="99" loading="lazy">
        </div>
      ...
      <div class="col-sm-12 col-sm-4 col-md-4 text-center">
        <div class="media media--adapt">
          <img class="multicolumn-card__image" srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/icon-2-environmentally.png" src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon-2-environmentally.png&amp;width=550" sizes="(min-width: 990px) 550px, (min-width: 750px) 550px, calc(100vw - 30px)" alt="" height="123" width="99" loading="lazy">
        </div>
        <div class="multicolumn-card__info">
      ...
      <div class="col-sm-12 col-sm-4 col-md-4 text-center">
        <div class="media media--adapt">
          <img class="multicolumn-card__image" srcset="<?php echo get_stylesheet_directory_uri(); ?>/img/icon-3-happiness.png" src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon-3-happiness.png&amp;width=550" sizes="(min-width: 990px) 550px, (min-width: 750px) 550px, calc(100vw - 30px)" alt="" height="123" width="99" loading="lazy">
        </div>
        <div class="multicolumn-card__info">
...
<section class="section-testimonials">
  <div class="container">
    <div class="testimonial-holder">
      ...
      <div class="quote">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/bubble-top.png" alt="">
        <div>&nbsp;</div>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/bubble-bottom.png" alt="">
      </div>
    </div>
  </div>
</section>
    ...
    <div class="box">
      <div class="row">
        <div class="col-sm-12 col-md-7 col1">
          <h2>Tiny tots getting too big for their boots?<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/img-bee-tots.jpg" alt=""></h2>
          <p>Don’t let your kid’s clothing end up in a landfill.<br>
            Learn how to sell with us - the easy way.</p>
        </div>
        <div class="col-sm-12 col-md-6 col2"><p><strong>Get clued and get selling.</strong></p>
